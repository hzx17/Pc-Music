<template>
  <div class="play-bar-main">
      ...
      <audio-box  @setCurrentTime="setCurrentTime" ref="audioRef"></audio-box>
  </div>
</template>

<script setup>
import AudioBox from '@components/Audio/AudioBox.vue';
import Bar from '@components/Audio/Bar.vue';
import { provide, onMounted , ref } from 'vue';

const audioRef = ref(null)
const currentTime = ref(0) 
const barType = ref('Bar')  // 标准底部组件

// 歌曲播放操作： 播放、暂停、上一首、下一首 play ...
